...
public class StringComparison {
	...
	public static void main(String[] args) {
		...
		String s3=new String("DIVAKAR");
		String s4=new String("DIVAKAR");
		
		//== and equals
		System.out.println("case1-->"+s1.equals(s2)); //true
		
		System.out.println("case2-->"+s1.equals(s3)); //true
	...
	//	System.out.println(s1.hashCode());
		System.out.println(s1.compareTo("divakar")); //
		
		System.out.println(s1.compareToIgnoreCase("divakar"));
